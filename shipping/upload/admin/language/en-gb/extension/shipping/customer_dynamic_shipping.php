<?php
$_['heading_title']    = 'Customer dynamic shipping';

$_['text_extension']   = 'Extensions';
$_['text_success']     = 'Success: You have modified customer dynamic shipping!';
$_['text_edit']        = 'Edit customer dynamic shipping';
$_['text_enabled']     = 'Enabled';
$_['text_disabled']    = 'Disabled';
$_['text_all_zones']   = 'All Zones';
$_['text_none']        = 'None';
$_['text_home']        = 'Home';
$_['text_no_methods']  = 'No shipping profiles yet.';
...
$_['tab_methods']   = 'Shipping profiles';
...
$_['entry_bind_method']    = 'Shipping profile';
...
$_['help_methods']  = 'Define logical shipping options (name, code for ERP, API ID). Each appears as a sub-option at checkout for customers who are linked to it.';
$_['help_bindings'] = 'Link customers to one or more profiles. Search filters by customer name, email, profile name, code, or API ID.';

$_['error_permission'] = 'Warning: You do not have permission to modify customer dynamic shipping!';
$_['error_method_name'] = 'Display name is required.';
$_['error_method_code'] = 'Internal code is required.';
$_['error_binding']     = 'Select a customer and a shipping profile.';
